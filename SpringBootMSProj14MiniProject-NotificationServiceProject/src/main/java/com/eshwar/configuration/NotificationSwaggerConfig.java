//NotificationSwaggerConfig .java(Configuration Class Contains API Information)
...
public class NotificationSwaggerConfig 
{
	   ...
	   {
		   log.debug("NotificationSwaggerConfig  Class customOpenAPI() method is executed...");
		   
		   log.info("NotificationSwaggerConfig  Class customOpenAPI() method is returning OpenAPI Class Object...");
		   return new OpenAPI()//This creates an OpenAPI object. Think of it as a API Documentation Object
				       .info(new Info()//This creates an Info Object which contains the API Information like title,version,description,contact and etc.
				    		 .title("Notification Service API") //This sets the title of the API Documentation which is appears  on the Swagger UI Page.
				    		    .version("1.0")//This sets the version of the API Documentation which is appears  on the Swagger UI Page.
				    		       .description("Rest APIs For Notification Service")//This sets the description of the API Documentation,Which is useful for explaining what this service does.
